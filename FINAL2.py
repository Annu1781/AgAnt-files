...
def run_pipeline(pdb_id, mol2_path, smiles, ligand_code):
    ...
    SMILES =smiles
    mol2_file = mol2_path
    current_directory = '/10tb-storage/riddhis/bhumika/final_scripts_R'
    csv_name=pdb_id
    ...
    def generate_input_txt(pdb_id, ligand_id):
        ...
        with open(input_txt, 'w') as file:
            file.write(f'/10tb-storage/riddhis/bhumika/final_scripts_R/{pdb_id} {ligand_id}')
   ...
   # Run the shell script
    os.system(f"bash /10tb-storage/riddhis/bhumika/final_scripts_R/run_cavity.sh {cavity_input_path}")
...
# Load the trained XGBoost model from the .pkl file
    ...
    #training_data_filename = '/10tb-storage/riddhis/bhumika/final_scripts_R/ANOVA_Selected_data.csv'
...
# Make predictions using the loaded XGBoost model
    ...
    json.dumps(print(predictions_pkl[0]))
